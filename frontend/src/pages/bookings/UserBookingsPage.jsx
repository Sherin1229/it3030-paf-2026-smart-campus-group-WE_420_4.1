...
const UserBookingsPage = () => {
  ...
  useEffect(() => {
    const fetchRecent = async () => {
      try {
        const API_URL = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080/api'}/bookings/my?email=${user.email}`
  ...
  const bookingActions = [
    ...
    {
      title: 'Self Check-in',
      text: 'Scan resource QR code at the location to confirm attendance.',
      link: '/dashboard/user/bookings/scan',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect><path d="M7 7h1v1H7z"></path><path d="M7 16h1v1H7z"></path><path d="M16 7h1v1H16z"></path><path d="M16 16h1v1H16z"></path><path d="M12 7h1v1h-1z"></path><path d="M7 12h1v1H7z"></path><path d="M12 12h1v1h-1z"></path><path d="M16 12h1v1h-1z"></path><path d="M12 16h1v1h-1z"></path></svg>
      )
    },
  ]
